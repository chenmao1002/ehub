...
def main():
    ...
    # Bridge frame: [0xAA][0x55][CH=0xE0][LEN_H=0x00][LEN_L=0x01][DATA=0x04][CRC]
    # CRC = CH ^ LEN_H ^ LEN_L ^ DATA = 0xE0 ^ 0x00 ^ 0x01 ^ 0x04 = 0xE5
    frame = bytes([0xAA, 0x55, 0xE0, 0x00, 0x01, 0x04, 0xE5])
